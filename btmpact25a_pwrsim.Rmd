...
sim <- function(n = 100000, DF = DF){
  ...
  sampled_data  <-  DF %>%
    ...
    outcome_df[1,] <- c(n, rep(NA, times = 8)) # fill in sample size
  ...
  ## record the BIC difference between the linear and quad model
  ...
  ## record the BIC difference between the linear and log model
